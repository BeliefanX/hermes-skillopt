...
- Documents current Phase0-3 behavior: staged-only Hermes SkillOpt adapter, provenance v2, separated optimizer/target backends, hard/soft/mixed gate modes, conservative resume checkpoints, history/lineage, slow/meta evidence, EnvAdapter benchmark/session foundation, benchmark bridge, transfer eval, conformance, and WebUI review surfaces.
